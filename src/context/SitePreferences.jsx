...
const copy = {
  uz: {
    ...
    "nav.home": "Bosh sahifa", "nav.courses": "Kurslar", "nav.news": "Yangiliklar", "nav.results": "Natijalar", "nav.team": "Jamoamiz", "nav.rules": "Markaz qoidalari", "nav.contact": "Kontakt", "nav.consultation": "Bepul maslahat",
  ...
  ru: {
    ...
    "nav.home": "Главная", "nav.courses": "Курсы", "nav.news": "Новости", "nav.results": "Результаты", "nav.team": "Команда", "nav.rules": "Правила центра", "nav.contact": "Контакты", "nav.consultation": "Бесплатная консультация",
  ...
  en: {
    ...
    "nav.home": "Home", "nav.courses": "Courses", "nav.news": "News", "nav.results": "Results", "nav.team": "Our team", "nav.rules": "Centre rules", "nav.contact": "Contact", "nav.consultation": "Free consultation",

...
const copy = {
  uz: {
    ...
    "nav.home": "Bosh sahifa", "nav.courses": "Kurslar", "nav.news": "Yangiliklar", "nav.results": "Natijalar", "nav.mandate": "Mock natijalari", "nav.studentResults": "O‘quvchilar natijalari", "nav.resultsHint": "Yutuqlar va o‘sish tahlili", "nav.mandateCheck": "Mock natijani tekshirish", "nav.mandateHint": "To‘liq ism-familiya orqali", "nav.team": "Jamoamiz", "nav.rules": "Markaz qoidalari", "nav.contact": "Kontakt", "nav.consultation": "Bepul maslahat",
  ...
  ru: {
    ...
    "nav.home": "Главная", "nav.courses": "Курсы", "nav.news": "Новости", "nav.results": "Результаты", "nav.mandate": "Результаты mock-теста", "nav.studentResults": "Результаты учеников", "nav.resultsHint": "Достижения и анализ роста", "nav.mandateCheck": "Проверить mock-тест", "nav.mandateHint": "По полному имени и фамилии", "nav.team": "Команда", "nav.rules": "Правила центра", "nav.contact": "Контакты", "nav.consultation": "Бесплатная консультация",
  ...
  en: {
    ...
    "nav.home": "Home", "nav.courses": "Courses", "nav.news": "News", "nav.results": "Results", "nav.mandate": "Mock results", "nav.studentResults": "Student results", "nav.resultsHint": "Achievements and progress", "nav.mandateCheck": "Check mock result", "nav.mandateHint": "By full name and surname", "nav.team": "Our team", "nav.rules": "Centre rules", "nav.contact": "Contact", "nav.consultation": "Free consultation",
